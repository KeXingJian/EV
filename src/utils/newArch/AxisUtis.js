...
import {unloadSeries, unloadSeriesLazy} from "./Check4Series.js";
...
export const loadAxis = (c,echartsOptions)=>{
    ...
    if (c.type === 0){
        console.log('加载x0y轴')
        loadX0yAxis(c,echartsOptions)
    }else if(c.type === 1){
        console.log('加载极坐标轴')
        loadPolarAxis(c,echartsOptions)
    }else {
        console.log('饼图不加载任何轴')
    }
